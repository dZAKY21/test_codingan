...
<head>
  ...
  <script>
    ...
    ga('require', 'linker');
    ga('linker:autoLink'), ["2checkout.com"], "avgat"  </script>
  ...
  <script defer data-site="demos.creative-tim.com"
    src="{{ asset('https://api.nepcha.com/js/nepcha-analytics.js') }}"></script>
</head>

<body class="g-sidenav-show  bg-gray-100">


  <noscript><iframe src="{{ asset('https://www.googletagmanager.com/ns.html?id=GTM-NKDMSK6') }}" height="0" width="0"
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="{{ url('kategori_produk') }}">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url{{ asset ('img/curved-images/white-curved.jpg') }}">
        </div>
        <div class="card-body text-start p-3 w-100">
          ...
          <div class="docs-info">
            ...
            <a href="{{ asset ('https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard') }}"
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
                href="{{ asset ('javascript:;') }}">Pages</a></li>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank"
                href="{{ asset('https://www.creative-tim.com/builder?ref=navbar-soft-ui-dashboard') }}">Produk
                Terkini
              </a>
            </li>
            <li class="nav-item d-flex align-items-center">
              <a href="{{ asset ('javascript:;') }}" class="nav-link text-body font-weight-bold px-0">
                <i class="fa fa-user me-sm-1"></i>
                <span class="d-sm-inline d-none">Sign In</span>
              </a>
            </li>
            <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
              <a href="{{ asset ('javascript:;') }}" class="nav-link text-body p-0" id="iconNavbarSidenav">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
              <a href="{{ asset ('javascript:;') }}" class="nav-link text-body p-0">
                <i class="fa fa-cog fixed-plugin-button-nav cursor-pointer"></i>
              </a>
            </li>
            <li class="nav-item dropdown pe-2 d-flex align-items-center">
              <a href="{{ asset ('javascript:;') }}" class="nav-link text-body p-0" id="dropdownMenuButton"
  ...
  <div class="fixed-plugin">
    ...
    <div class="card shadow-lg ">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a href="{{ asset ('javascript:void(0)') }}" class="switch-trigger background-color">
        ...
        <a class="btn btn-outline-dark w-100"
          href="{{ asset('https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard') }}">View
          documentation</a>
        <div class="w-100 text-center">
          <a class="github-button" href="{{ asset ('https://github.com/creativetimofficial/soft-ui-dashboard') }}"
            data-icon="octicon-star" data-size="large" data-show-count="true"
            aria-label="Star creativetimofficial/soft-ui-dashboard on GitHub">Star</a>
          <h6 class="mt-3">Thank you for coming!</h6>
          <a href="{{ asset ('https://twitter.com/intent/tweet?text=Check%20Soft%20UI%20Dashboard%20made%20by%20%40CreativeTim%20%23webdesign%20%23dashboard%20%23bootstrap5&amp;url=https%3A%2F%2Fwww.creative-tim.com%2Fproduct%2Fsoft-ui-dashboard') }}"
            class="btn btn-dark mb-0 me-2" target="_blank">
            <i class="fab fa-twitter me-1" aria-hidden="true"></i> Tweet
          </a>
          <a href="{{ asset ('https://www.facebook.com/sharer/sharer.php?u=https://www.creative-tim.com/product/soft-ui-dashboard') }}"
            class="btn btn-dark mb-0 me-2" target="_blank">
  ...
  <script>
    ...
    if (win && document.querySelector('#sidenav-scrollbar')) {
      ...
      Scrollbar.init(document.querySelector('#sidenav-scrollbar'), ons);
    }
  </script>
